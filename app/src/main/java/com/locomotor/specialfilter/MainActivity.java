...
//        KeyWords strings = KeyWords.getInstance();
//        allStrings = strings.allStrings;
        ...
        filterText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                for (i=0 ; i < allStrings.size() ; i++) {
                    String rawSearch = allStrings.get(i);
                    String search = StringUtils.stripAccents(rawSearch.toUpperCase());
                    String mySearch = StringUtils.stripAccents(s.toString().toUpperCase());
                    if (search.contains(mySearch)) {
                        result.setText(rawSearch);
                        Log.e("result", "" + rawSearch);
                    }

                }

                Log.e("Solution: ", ""+StringUtils.stripAccents(s.toString()));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar.make(view, "Filter Completed!", Snackbar.LENGTH_LONG).setAction("Action", null).show();
